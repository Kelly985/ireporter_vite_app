...
class Call(db.Model):
    ...
    # Update the user relationship with back_populates and overlaps
    caller = db.relationship('User', back_populates='calls', foreign_keys=[user_id], lazy=True, uselist=False, overlaps='calls')
